...
- Chat also runs as a webhook-woken cloud routine (DECISIONS/0007). Both partners answer the Table within minutes. Builder runs at 02:00 and 05:00 New York. Failure handling is listed at the end of ROUTINES.md.
