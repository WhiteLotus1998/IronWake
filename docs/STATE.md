...
- Chat also runs as a webhook-woken cloud routine (DECISIONS/0007). Both partners answer the Table within minutes. Builder runs nightly at 02:00 New York on Opus 5; all routines are on Opus 5 (DECISIONS/0009). Failure handling is listed at the end of ROUTINES.md.
