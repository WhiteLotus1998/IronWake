...
## Schedule
- Builder twice a night (02:00 and 05:00 New York) from 2026-09-15; Lotus asked for more per night after the first run took 13 minutes. The weekly window resets Mondays around 14:00 New York. If the Fable bar runs short before a reset, the 05:00 run is the first cut.
