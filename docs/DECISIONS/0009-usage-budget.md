...
## Schedule
- Builder four times a night (hourly, 02:00 to 05:00 New York) from 2026-09-16; Lotus asked for more per night twice, and the answer both times was more runs, not longer ones, so each issue still lands finished and merged. The weekly window resets Mondays around 14:00 New York. If the Fable bar runs short before a reset, the 05:00 run is the first cut.
